...
const VetReport = ({data}) => {
    ...
    const downloadPDF = () => {
        ...
        doc.text("Vets Report", (pageWidth / 2), 60, { align: "center" });
        // Underline the text
        const textWidth = doc.getStringUnitWidth("Vets Report") * doc.internal.getFontSize() / doc.internal.scaleFactor;
        ...
        doc.save("vets.pdf"); //Change name accordingly
      };
