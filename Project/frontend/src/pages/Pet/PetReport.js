...
const PetReport = ({data}) => {
    ...
    const downloadPDF = () => {
        ...
        doc.text("Pet Register Report", (pageWidth / 2), 60, { align: "center" });
        // Underline the text
        const textWidth = doc.getStringUnitWidth("Pet Register Report") * doc.internal.getFontSize() / doc.internal.scaleFactor;
        ...
        doc.save("pets.pdf"); //Change name accordingly
      };
