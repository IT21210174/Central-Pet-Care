...
const TreatmentReport = ({data}) => {
    ...
    const downloadPDF = () => {
        ...
        doc.text("Treatment Report", (pageWidth / 2), 60, { align: "center" });
        // Underline the text
        const textWidth = doc.getStringUnitWidth("Treatment Report") * doc.internal.getFontSize() / doc.internal.scaleFactor;
