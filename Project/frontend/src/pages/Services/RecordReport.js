...
const RecordReport = ({data}) => {
    ...
    const downloadPDF = () => {
        ...
        doc.text("Service Record Report", (pageWidth / 2), 60, { align: "center" });
        // Underline the text
        const textWidth = doc.getStringUnitWidth("Service Record Report") * doc.internal.getFontSize() / doc.internal.scaleFactor;
        ...
        doc.save("records.pdf"); //Change name accordingly
      };
